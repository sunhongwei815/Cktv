 ...
 */
public class Publish_tpl {
    private long publish_tpl_id;
    ...
    public long getPublish_tpl_id() {
        return publish_tpl_id;
    }

    public void setPublish_tpl_id(long publish_tpl_id) {
        this.publish_tpl_id = publish_tpl_id;
    }
    ...
    public long getPlay_order() {
        return play_order;
    }

    public void setPlay_order(long play_order) {
    ...
    public long getSource_tpl_id() {
        return source_tpl_id;
    }

    public void setSource_tpl_id(long source_tpl_id) {
        this.source_tpl_id = source_tpl_id;
    }
